...
% ===================================================================
\begin{abstract}
Chúng tôi trình bày hệ thống dự báo doanh thu và COGS hàng ngày cho doanh nghiệp thời trang TMĐT Việt Nam, giai đoạn 01/01/2023–01/07/2024, huấn luyện trên lịch sử 2012–2022 (3.833 ngày, 14 bảng dữ liệu). Pipeline gồm ba lớp: (1)~94 đặc trưng lịch thuần tuý tính trước hoàn toàn; (2)~ensemble LightGBM Q-Specialist đa seed kết hợp Ridge và Prophet; (3)~hệ số hiệu chỉnh CR suy diễn từ tăng trưởng YoY ngành TMĐT theo báo cáo MoIT 2022. Mô hình tốt nhất (v47, 10 seeds) đạt \textbf{MAE = 669.087} trên leaderboard — vị trí dẫn đầu cuộc thi. Phân tích SHAP xác nhận Fourier năm (31,5\%) và xu hướng thời gian (21,9\%) là hai driver chính, với Urban Blowout được nhận diện đúng là sự kiện margin âm.
\end{abstract}
...
\begin{table}[h!]
\centering
\caption{5 đề xuất hành động có định lượng dựa trên bằng chứng dữ liệu}
\label{tab:prescriptive}
\footnotesize
\setlength{\tabcolsep}{3.5pt}
\begin{tabular}{p{2.2cm}p{2.8cm}p{3.6cm}p{2.4cm}}
\toprule
\textbf{Vấn đề} & \textbf{Bằng chứng} & \textbf{Hành động} & \textbf{Tác động ước tính} \\
\midrule
Urban Blowout lỗ gộp & Q3-odd COGS/Rev = 1,057 & Cap chiết khấu $\leq$8\% Q3-odd & +60M VNĐ/campaign \\
\addlinespace[2pt]
Retention = 0\% & Gap trung vị 146 ngày & Email re-engagement D+30–60 (Email CLV 172K $\approx$ Referral 171K) & Repeat rate 1\%$\to$5\% \\
\addlinespace[2pt]
Overstock nghiêm trọng & Sell-through 20\%, fill rate 95\% & Giảm EOQ 30\% cho SKU rating $<$3,5; ưu tiên nhập hàng SKU rating $\geq$4,5 + stockout $\geq$40 ngày & Giải phóng ~75\% tồn trữ \\
\addlinespace[2pt]
Chu kỳ lương chưa khai thác & SHAP: payday top-4 driver & Flash sale ngày 28–31, kênh Email (bounce 44,58\%, thấp nhất) & Revenue $\uparrow$~25–35\% cuối tháng \\
\addlinespace[2pt]
Trả hàng sai size 35\% & Nhất quán qua 4 danh mục & AI size recommender (lịch sử + review) & Return rate 5,6\%$\to$$<$4\%, tiết kiệm $\sim$1,6\% GMV \\
\bottomrule
\end{tabular}
\end{table}
